...
public class ProgramFragment extends Fragment implements View.OnClickListener, View.OnLongClickListener{
    ...
    Button btnDel;Button btnPlus;Button btnMinus;Button btnDivide;Button btnX;Button btnEqual;Button btnA;
    Button btnB;Button btnC;Button btnD;Button btnE;Button btnF;
    Button btnOpen;
    Button btnClose;
    ...
    public void initiatelayout(View view){
        btn1 = (Button) view.findViewById(R.id.btn1);btn2 = (Button) view.findViewById(R.id.btn2);btn3 = (Button) view.findViewById(R.id.btn3);
        btn4 = (Button) view.findViewById(R.id.btn4);btn5 = (Button) view.findViewById(R.id.btn5);btn6 = (Button) view.findViewById(R.id.btn6);
        btn7 = (Button) view.findViewById(R.id.btn7);btn8 = (Button) view.findViewById(R.id.btn8);btn9 = (Button) view.findViewById(R.id.btn9);
        btn0 = (Button) view.findViewById(R.id.btn0);btnDel = (Button) view.findViewById(R.id.btnDel);
        btnPlus = (Button) view.findViewById(R.id.btnPlus);btnMinus = (Button) view.findViewById(R.id.btnMinus);btnDivide = (Button) view.findViewById(R.id.btnDivide);
        btnX = (Button) view.findViewById(R.id.btnX);btnEqual = (Button) view.findViewById(R.id.btnEqual);
        ...
        MaterialRippleLayout.on(linLayout)
                .rippleColor(Color.parseColor("#424242"))
                .rippleAlpha(1)
        ...
        btnC = (Button) view.findViewById(R.id.btnC);btnD = (Button) view.findViewById(R.id.btnD);btnE = (Button) view.findViewById(R.id.btnE);
        ...
        btn9.setOnClickListener(this);btn0.setOnClickListener(this);btnDel.setOnClickListener(this);
        ...
        btnEqual.setOnClickListener(this);btnA.setOnClickListener(this);btnB.setOnClickListener(this);
    ...
    /*boolean letGo(LinkedList<Long> st, char oper) {
        // Инициализируем и объявляем две переменные
        // Первая берет последнее значение из переданного
        // связанного листа в параметре, запоминает и удаляет
        // его из списка
        long someOne = st.removeLast();

        long someTwo = st.removeLast();
    ...
    long eval(String s) {
        ...
        // Создаем два контейнера типа LinkedList
        // Один для чисел, другой для символов
        LinkedList<Long> someNumbers = new LinkedList<>();
        LinkedList<Character> someOpers = new LinkedList<>();
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            // Если натыкаемся на закрывающуюся скобку
                ...
                // удаляя его опосля
                while (someOpers.getLast() != '(') {
                    boolean isGood = letGo(someNumbers, someOpers.removeLast());
                    if (!isGood) {
                        return 0;
                    }
                }
            ...
            // то мы ожидаем число
                ...
                // Числовой Контейнер
                --i;
                someNumbers.add(Long.parseLong(operand, baseFrom));
                Log.d("operand10", "" + Long.parseLong(operand, baseFrom));
            }
        }
